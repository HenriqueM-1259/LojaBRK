		...
		static void Main(string[] args)
		{
			...
			if (opcao == "1")
			{
				...
				do
				{
					...
					{
						case 1:
							lancheSelecionado = "X-Salada";
							precoLanche = 15;
							sair = false;
							break;
						case 2:
							lancheSelecionado = "X-Tudo";
							precoLanche = 25;
							sair = false;
							break;
						case 3:
							lancheSelecionado = "X-Egg";
							precoLanche = 17;
							sair = false;
							break;
						default:
				...
				do
				{
					...
					Console.WriteLine("Adicione seu endereço");
				...
				do
				{
					...
					Console.WriteLine("Adicione numero da casa");
				...
				Console.WriteLine("Endereço: {0}", enderecos);
